public class Telefon {
    ...
    private boolean imeiKaydiVarMi; // Yeni eklenen: fiyati doğrudan etkiler

    private double ekranBoyutuInc;
    private int arkaKameraMP;
    private int onKameraMP;

    public Telefon(String marka, String model, int depolamaKapasitesi, int pilSagligi, int cihazYasiAy,
    ...
    // --- Mevcut Getter ve Setter Metotları ---
    // (Kodun kısalığı için diğerlerini buraya tekrar yazmıyorum, sadece yenisini ekliyorum)

    public boolean isImeiKaydiVarMi() {
        return imeiKaydiVarMi;
    }

    public void setImeiKaydiVarMi(boolean imeiKaydiVarMi) {
        this.imeiKaydiVarMi = imeiKaydiVarMi;
    }

    // ... Diğer tüm getter/setter metotlarınız burada kalmaya devam etmeli ...
